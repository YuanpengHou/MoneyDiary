...
Frontend/View/视图层 -> Server/Backend/Springboot application/服务端 -> Controller/控制层 -> ServiceImplement/业务执行层 -> Service/业务层逻辑层 -> Repository/DAO/Mapper层/持久层 -> Mondel/Entity/Object/Data/DTO/模型层/实体层/数据层
